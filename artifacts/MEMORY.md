...
- Skill analytics model: usage-event ingestion is intentionally gated behind a discovery step; `sync360:skills:discover-analytics` writes `artifacts/skill-analytics-discovery.md`, and no analytics event tables or scheduled rollups exist until that finding is approved
