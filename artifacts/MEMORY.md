...
- Tenant skill runtime model: live custom skills are materialized into `.openclaw/workspace/skills/<skill-id>/...`; the old `.openclaw/workspace/skill-packs/...` path is explicitly cleaned up during tenant apply
