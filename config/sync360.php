...
return [
    ...
    'runtime_capabilities' => [
        ...
        'weasyprint' => [
            'id' => 'weasyprint',
            'activation' => 'workspace_dependency',
            'install_strategy' => 'python_venv',
            'version' => '61.2',
            'host_root' => '/opt/sync360/weasyprint',
            'venv_path' => '/opt/sync360/weasyprint/venv',
            'host_install_path' => '/opt/sync360/weasyprint/venv/bin/weasyprint',
            'python_package' => 'weasyprint==61.2',
            'system_packages' => [
                'python3',
                'python3-venv',
                'python3-pip',
            ...
            'container_mounts' => [
                [
                    'source' => '/opt/sync360/weasyprint',
                    'target' => '/opt/sync360/weasyprint',
                    'read_only' => true,
                ],
            ],
            'env' => [
                'WEASYPRINT_BIN' => '/opt/sync360/weasyprint/venv/bin/weasyprint',
            ],
            'openclaw_skills' => [],
            'host_verify_commands' => [
                'test -x {{path}}',
                '{{path}} --version 2>&1 | grep -qF {{version}}',
                '{{path}} --info >/dev/null 2>&1',
            ],
            'container_verify_command' => 'test -x "$WEASYPRINT_BIN" && "$WEASYPRINT_BIN" --info >/dev/null 2>&1',
        ],
    ],
    'skill_registry' => [
        'hello-world' => [
